...
\date{15 February 2015}  % if the \date{} command is left out, the current date will be used
...
\newthought{The study of Astronomy}, is that it is \emph{AwesomE}\sidenote{It really really is.}, and I think I'm going to be able to use \LaTeX to produce my notes.
